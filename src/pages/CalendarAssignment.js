...
function CalendarAssignment() {
  ...
  const onClickToDetail = () => {
    navigate(`/study-group/${gpId}/log/${assignments.log}`);
  };
  const onClickToBoxes = () => {
    navigate(`/study-group/${gpId}/assignment`);
  };
        ...
        <div id="div-scroll-main-calendar" class="div-layout-lower-2">
          {loading ? (
            ...
            <>
              <div
                id="div-layout-1"
                className="layout-study colored-layout-div"
              >
                <LayoutStudyPage gpId={gpId} groupName={info.groupName} />
              </div>
              ...
              <div id="div-layout-grid">
                <div id="div-grid-cal-asgmt">
                  <div id="div-layout-2" className="layout-cal-asgmt">
                    <h3>
                      <strong>{assignments.title}</strong>
                    </h3>
                    <CalculateDue
