  ...
  return (
    <div>
      ...
      <div>
        <button
          type="button"
          onClick="location.href='/study-group/{{groupPublicId}}/setting'"
        >
          스터디 설정
        </button>{' '}
        <br />
      ...
      <div>
        <PageLink link={`/study-group/${gpId}/member`} title={'회원 관리'} />
        <br />
        <PageLink link={`/study-group/${gpId}/assignment`} title={'과제함'} />
        <br />
        <PageLink link={`/study-group/${gpId}/videoChat`} title={'화상회의'} />
      </div>
    </div>
  );
}
