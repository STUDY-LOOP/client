...
import { Button, Accordion, Table, Badge, Tooltip, OverlayTrigger, Form } from "react-bootstrap";
        ...
        <>
            <Accordion.Item eventKey={boxId}>
                ...
                <Accordion.Body>
                    ...
                    {gap < 0
                        ? <><Badge pill bg="primary">제출 마감</Badge> {deadline.substr(0, 10)}. {deadlineD.getHours()}시 {deadlineD.getMinutes()}분</>
                        : <><Badge pill bg="secondary">제출 마감</Badge> {deadline.substr(0, 10)}. {deadlineD.getHours()}시 {deadlineD.getMinutes()}분</>}
