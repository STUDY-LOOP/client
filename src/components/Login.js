        ...
        <div id="div-login" className="profile">
            {sessionStorage.getItem("user_nick") !== null
                ...
                ? <div id="after-login">
                    ...
                    <br/>
                    <button id="btn-my-profile" onClick={onClickProfile} className="btn">마이페이지</button>
                    <button id="btn-logout" onClick={onClickLogout} className="btn">로그아웃</button>
                </div>
                ...
                <div id="login-input">
                    ...
                    <OverlayTrigger trigger="click" placement="right" overlay={
                        <Popover>
                            <Popover.Header><h4><b>LOGIN</b></h4></Popover.Header>
                            <Popover.Body>
                                <FloatingLabel label="이메일" >
                                    <Form.Control type="email" placeholder="name@example.com" onChange={emailInputHandler} required />
                                </FloatingLabel> <br/>

                                <FloatingLabel label="비밀번호">
                                    <Form.Control type="password" placeholder="Password" onChange={pwInputHandler} required />
                                </FloatingLabel> <br/>

                                <Button id="enter-login" type="button" onClick={onClickLogin} className="btn">로그인 하기</Button> <br/><br/>
                            </Popover.Body>
                        </Popover>
                    }>
                        <button id="login" type="button" className="btn">로그인</button>
                    </OverlayTrigger>
