                ...
                <div className="Chat-div" style={{ margin: '5px 0px' }}>
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: '#c2c2c2' }}
                    >
                      {new Date(chat.datetime).getFullYear()}-
                      {new Date(chat.datetime).getMonth() + 1}-
                      {new Date(chat.datetime).getDate()}{' '}
                      {new Date(chat.datetime).getHours()}:
                      {new Date(chat.datetime).getMinutes()}
                    </span>
                  </div>
                  <div
                    className="Chat-div-content"
                ...
                <div className="Notice-div" style={{ margin: '5px 0px' }}>
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: '#c2c2c2' }}
                    >
                      {new Date(notice.datetime).getFullYear()}-
                      {new Date(notice.datetime).getMonth() + 1}-
                      {new Date(notice.datetime).getDate()}{' '}
                      {new Date(notice.datetime).getHours()}:
                      {new Date(notice.datetime).getMinutes()}
                    </span>
                  </div>
                  <div
                    className="Notice-div-content"
