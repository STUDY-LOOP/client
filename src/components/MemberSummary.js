                ...
                <Table responsive bordered hover className="tables">
                    <thead>
                        <tr>
                            ...
                            <td><b>지각</b></td>
                            {isAsgmt ? <td><b>미제출</b></td> : <td><b>결석</b></td>}
                            <td><b>총 벌금</b></td>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        {isAsgmt ?
                            <>{
                                assignment && assignment.map((asgmt) => (
                                    <>
                                        <tr>
                                            <td>{asgmt.nick}</td>
                                            <AssignmentResult
                                                ...
                                                isAsgmt={true}
                                            />
                                            <td><b>{asgmt.asgmtLateCnt}회</b></td>
                                            <td><b>{asgmt.asgmtAbsentCnt}회</b></td>
                                            <td><b>{asgmt.asgmtLateFee + asgmt.asgmtAbsentFee}원</b></td>
                                        </tr>
                                    </>
                                ))
                                    ...
                                    <>
                                        <tr>
                                            ...
                                            <AssignmentResult
                                                ...
                                                isAsgmt={false}
                                            />
                                            <td><b>{attend.studyLateCnt}회</b></td>
                                            <td><b>{attend.studyAbsentCnt}회</b></td>
                                            <td><b>{attend.studyLateFee + attend.studyAbsentFee}원</b></td>
                                        </tr>
                                    </>
                                ))
                            }</>
